...
!(function ($) {
    ...
    try {
      var isvip = getCookie('p_uid').substr(1, 1);
      _hmt.push(['_trackCustomEvent', 'adblock', { 'isadblock': getCookie('c_adb') || 0 }]);
      _hmt.push(['_trackCustomEvent', 'Useridentity', { 'isonline': getCookie('UserName') === '' ? 0 : 1, 'isvip': isvip === '1' ? 1 : 0 }]);
    } catch (e) {
      console.warn(e);
    }
